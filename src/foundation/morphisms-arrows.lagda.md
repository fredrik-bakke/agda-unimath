...
--           ( htpy-domain-htpy-hom-arrow f g α β H a)))
    ...
    ( right-whisk-coherence-triangle-homotopies' {! map-codomain-hom-arrow g h γ ·l coh-hom-arrow f g α !} {! !} {!   !} a) ∙
  ...
  left-whisker-htpy-hom-arrow :
    htpy-hom-arrow f h (comp-hom-arrow f g h γ α) (comp-hom-arrow f g h γ β)
...
module _
  ...
  coh-right-whisker-htpy-hom-arrow :
    coherence-htpy-hom-arrow f h
      ( comp-hom-arrow f g h α γ)
      ( comp-hom-arrow f g h β γ)
      ( htpy-domain-right-whisker-htpy-hom-arrow)
      ( htpy-codomain-right-whisker-htpy-hom-arrow)
  coh-right-whisker-htpy-hom-arrow =
    homotopy-reasoning
    ( map-codomain-hom-arrow g h α ·l coh-hom-arrow f g γ ∙h
      coh-hom-arrow g h α ·r map-domain-hom-arrow f g γ ∙h
      h ·l htpy-domain-htpy-hom-arrow g h α β H ·r map-domain-hom-arrow f g γ)
    ~ {!   !} by {! inv-htpy (right-transpose-htpy-concat ? ? ? (coh-htpy-hom-arrow g h α β H)) !}
    ~ {!   !} by {!   !}
    ~ ( htpy-codomain-htpy-hom-arrow g h α β H ·r map-codomain-hom-arrow f g γ ·r f ∙h
        ( map-codomain-hom-arrow g h β ·l coh-hom-arrow f g γ ∙h
          coh-hom-arrow g h β ·r map-domain-hom-arrow f g γ)) by {!   !}
  ...
  -- right-whisker-htpy-hom-arrow :
  --   htpy-hom-arrow f h
  --     ( comp-hom-arrow f g h γ α)
  --     ( comp-hom-arrow f g h γ β)
  -- pr1 right-whisker-htpy-hom-arrow =
  --   htpy-domain-right-whisker-htpy-hom-arrow
  -- pr1 (pr2 right-whisker-htpy-hom-arrow) =
  --   htpy-codomain-right-whisker-htpy-hom-arrow
  -- pr2 (pr2 right-whisker-htpy-hom-arrow) =
  --   coh-right-whisker-htpy-hom-arrow
```
